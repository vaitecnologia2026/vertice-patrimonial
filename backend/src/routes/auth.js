...
// Rate limit adicional por email — bloqueia ataques distribuídos contra uma única conta (CWE-307)
const loginEmailLimiter = rateLimit({
  ...
  message: { error: 'Muitas tentativas de login para esta conta. Aguarde 15 minutos.' },
});
